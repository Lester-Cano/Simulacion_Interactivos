 ...
 public class IntroMoverI5
    {
        ...
        //Aplicando directamente al mapeado de la longitud de los pasos en el step

            Vector3 pos = moverGO.transform.position + new Vector3(widthScale * Mathf.PerlinNoise(Time.time * xScale, 0.0f) * timeSinceReset, heightScale * Mathf.PerlinNoise(0.0f, Time.time * yScale) * timeSinceReset, 0);
