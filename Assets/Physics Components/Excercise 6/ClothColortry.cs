...
public class ClothColortry : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField] Material MaterialClothColliders;
    ...
    void Start()
    {
        ...
        while (i < clothColliderCount)
        {
            ...
            if (i >= clothColliderCount)
            {
                ...
                cloth = new clothObject(clothColliders, MaterialClothColliders);
            }
        }
...
public class clothObject
{
    ...
    public clothObject(CapsuleCollider[] clothColliders, Material clothMaterial)
    {
