...
public class RibbonSize : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxParticles = 1000;
        psf3 = new particleSystemFigure3(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, particleMaterial, trailMaterial);
    }
}
...
public class particleSystemFigure3
{
    ...
    public particleSystemFigure3(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material particleMaterial, Material trailmaterial)
    {
