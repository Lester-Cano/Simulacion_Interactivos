...
public class ColorLifetime : MonoBehaviour
{
    particleSystemFigureej2 psfej2;
    ...
    {
        maxParticles = 1000;
        psfej2 = new particleSystemFigureej2(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, particleMaterial);
    }
}

public class particleSystemFigureej2
{
    ...
    public particleSystemFigureej2(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material particleMaterial)
    {
