...
public class RibbonColorOverLifetime : MonoBehaviour
{
    particleSystemFigureej4 psfej4;
    ...
    void Start()
    {
        ...
        maxParticles = 1000;
        psfej4 = new particleSystemFigureej4(particleSystemLocation, startSpeed, velocity, lifeTime, maxParticles, particleMaterial, trailMaterial);
    }
}

public class particleSystemFigureej4
{
    ...
    public particleSystemFigureej4(Vector3 particleSystemLocation, float startSpeed, Vector3 velocity, float lifeTime, int maxParticles, Material particleMaterial, Material trailMaterial)
    {
    ...
    public void trailModule(Material trailMaterial)
    {
        ...
        trailsModule.sizeAffectsLifetime = true;
        ...
        //This gradient key lets us choose points on a gradient that represent different RGBA or Unity.Color values.
        //These gradient values exist in an array
        grad.SetKeys(new GradientColorKey[] { new GradientColorKey(Color.blue, 0.0f), new GradientColorKey(Color.magenta, 0.5f), new GradientColorKey(Color.red, 1.0f) }, new GradientAlphaKey[] { new GradientAlphaKey(1.0f, 0.0f), new GradientAlphaKey(0f, 2.0f) });
        //Set the color to the gradient we created above
