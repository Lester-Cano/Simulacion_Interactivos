...
public class MultipleSystems : MonoBehaviour
{
    Vector3 origin;
    ...
    void createParticleSystem(Vector3 origin)
    {
        ...
        psf2.particleSystemGameObject.transform.Rotate(new Vector3(130f, 0f, 0f));
    }
    ...
    void createParticleSystem(Vector3 origin, GameObject parentParticleSystem)
    {
        ...
        child.particleSystemGameObject.transform.Rotate(new Vector3(310f, 0f, 0f));
    }
}
