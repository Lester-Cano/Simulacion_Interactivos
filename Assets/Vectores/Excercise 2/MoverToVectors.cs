...
public class MoverToVectors : MonoBehaviour
{
    // We need to create a mover instance
    IntroMoverVector mover;

    // Start is called before the first frame update
    void Start()
    {
        mover = new IntroMoverVector();
    }
...
public class IntroMoverVector
{
    ...
    public void Step()
    {
        ...
        if (choice == 0)
        {
            mover.transform.position += new Vector3(1, 0, 0) * Time.deltaTime;
        }
        else if (choice == 1)
        {
            mover.transform.position += new Vector3(-1, 0, 0) * Time.deltaTime;
        ...
        {
            mover.transform.position += new Vector3(0, 1, 0) * Time.deltaTime;
        }
        else if (choice == 3)
        {
            mover.transform.position += new Vector3(0, -1, 0) * Time.deltaTime;
