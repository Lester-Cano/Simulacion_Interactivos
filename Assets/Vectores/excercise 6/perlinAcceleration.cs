...
public class perlinAcceleration : MonoBehaviour
{
...
public class Mover1_9
{
    ...
    public void Step()
    {
        // Random acceleration with perlin noise
        acceleration = new Vector2(Mathf.PerlinNoise(-1f, 1f), Mathf.PerlinNoise(-1f, 1f));

        // Normalize the acceletation
        acceleration.Normalize();

        // Now we can scale the magnitude as we wish using perlin noise
        acceleration *= Mathf.PerlinNoise(-1f, 1f);
